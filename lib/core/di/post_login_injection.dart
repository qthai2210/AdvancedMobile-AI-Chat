...
import 'package:aichatbot/core/di/user_profile_injection.dart';
...
Future<void> initPostLoginServices() async {
  ...
  // Register user profile dependencies
  ...
  if (!sl.isRegistered<ValidateTelegramBotUseCase>())
    sl.registerLazySingleton(() => ValidateTelegramBotUseCase(sl()));
